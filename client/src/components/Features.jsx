      ...
      <section className="py-12 bg-blue-50 sm:py-16 lg:py-20">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold leading-tight text-blue-900 sm:text-4xl xl:text-5xl font-pj">
          ...
          <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
            <div className="md:p-8 lg:p-14">
              ...
              <h3 className="mt-12 text-xl font-bold text-blue-900 font-pj">
                Event Creation & Scheduling
              </h3>
              <p className="mt-5 text-base text-gray-600 font-pj">
                Easily create, schedule, and manage events with just a few
                clicks. Organizers can set dates, add descriptions, and
                customize event types effortlessly.
              </p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
              ...
              <p className="mt-5 text-base text-gray-600 font-pj">
                Supports multiple user roles like Organizer, Attendee, and Admin, ensuring proper access control and personalized experience for every user.
              </p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
              ...
              <p className="mt-5 text-base text-gray-600 font-pj">
                Attendees can book or cancel event tickets in real-time. The system prevents duplicate bookings and notifies users about registration status instantly.
              </p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
              ...
              <p className="mt-5 text-base text-gray-600 font-pj">
                Collect attendee feedback after events to improve future experiences. Built-in feedback module enables quick rating and comment submissions for each event.
              </p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
              ...
              <p className="mt-5 text-base text-gray-600 font-pj">
                Admins get access to real-time analytics, including user counts, ticket stats, feedback summaries, and more — all displayed in a clear, digestible format.
              </p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
              ...
              <p className="mt-5 text-base text-gray-600 font-pj">
                JWT-based login ensures user sessions are secure. Cookie-based tokens keep users logged in for 24 hours with role-protected routes for extra security.
              </p>
            </div>
          </div>
        </div>
  ...
  <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
      ...
      <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
        ...
        <h3 className="mt-12 text-xl font-bold text-blue-900 font-pj">Sales</h3>
        <p className="mt-5 text-base text-gray-600 font-pj">
          Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec,
          proin faucibus nibh et sagittis a. Lacinia purus ac amet.
        </p>
